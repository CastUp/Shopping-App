...
import 'package:Shopping/Parts/Admin/InnerScreen/InnerCategories/CreateCategory.dart';
import 'package:Shopping/Parts/Admin/InnerScreen/InnerCategories/EditCategory.dart';
...
class _CategoriesState extends State<Categories> with AlertDialogs {
                      ...
                      TableRow(children: <Widget>[
                        Container(
                          ...
                          child: TextField(
                            ...
                            style: TextStyle(color: Colors.black, fontSize:lang.contains("ar")? 20: 18 , fontFamily: lang.contains("ar") ? Constants.splashArabicFont : null,),
                            decoration: InputDecoration(
                              hintText: SetLocalization.of(context)!.getTranslateValue(Keys.categoryTitle)!,
                              hintStyle: TextStyle(color: Colors.grey, fontSize: lang.contains("ar")? 21: 16, fontFamily: lang.contains("ar")? Constants.splashArabicFont : null),
                        ...
                        TextButton(
                          ...
                          onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_)=> CreateCategory())),
                        )
                      ])
                    ],
                  ),
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Table(
                          ...
                          children: <TableRow>[
                            ...fetchCategoriesData(snapshot.data!, searchCategory: this.search)
                                .map((objectCategory) => TableRow(
                                children: [
                                  Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      radius: 50,
                                      child: Text(
                                        objectCategory.get(Constants.DESCRIPTIONCATEGORY).toString().length > 60
                                            ? Constants.showTextEn(info: objectCategory.get(Constants.DESCRIPTIONCATEGORY))
                                            .substring(0, 59) + "..." : Constants.showTextEn(info: objectCategory.get(Constants.DESCRIPTIONCATEGORY)),
                                        style: TextStyle(
                                          color: Colors.black,
                                            ...
                                            builder: (context) =>
                                                FutureBuilder(
                                                  future: value.productsNumber(
                                                      title: objectCategory.get(Constants.NAMECATEGORY)),
                                                  builder: (context,
                                                      snapshot) =>
                                                      AlertDialog(
                                                              ...
                                                              children: <
                                                                ...
                                                                Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      ...
                                                                      image: DecorationImage(image: NetworkImage(objectCategory.get(Constants.IMAGECATEGORY)), fit: BoxFit.fill)),
                                                                ),
                                                                SizedBox(
                                                                  width:
                                                                  5,
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        RichText(
                                                                            text: TextSpan(children: <TextSpan>[
                                                                              TextSpan(text: "${SetLocalization.of(context)!.getTranslateValue(Keys.category)!}: ",
                                                                                  style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.w600)),
                                                                              TextSpan(text: Constants.showTextEn(info: objectCategory.get(Constants.NAMECATEGORY)), style: TextStyle(fontSize: 14, color: Colors.red, fontWeight: FontWeight.w400)),
                                                                            ])),
                                                                        SizedBox(
                                                                          height: 10,
                                                                        ),
                                                                        RichText(
                                                                            text: TextSpan(children: <TextSpan>[
                                                                              TextSpan(text: "${SetLocalization.of(context)!.getTranslateValue(Keys.brandTableDescription)!}: ",
                                                                                  style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.w600)),
                                                                              TextSpan(text: Constants.showTextEn(info: objectCategory.get(Constants.DESCRIPTIONCATEGORY)), style: TextStyle(fontSize: 14, color: Colors.red, fontWeight: FontWeight.w400)),
                                                                            ])),
                                                                        SizedBox(
                                                                          height: 10,
                                                                        ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        IconButton(
                                            ...
                                            onPressed: ()=> Navigator.push(context, MaterialPageRoute(builder: (_)=> EditCategory(idItem: objectCategory.get(Constants.IDCATEGORY))))),
                                        IconButton(
                                          icon: Icon(Icons.delete, color: Colors.red.shade500,),
                                          onPressed: () => showDialog(context: context,
                                            builder: (context)
                                            => showAlertDialog(context,
                                                function: () => value.deleted(context, idItem: objectCategory.get(Constants.IDCATEGORY), title: objectCategory.get(Constants.NAMECATEGORY)),
  ...
  List fetchCategoriesData(List<QueryDocumentSnapshot> listCategoryFirebase, {String? searchCategory}) {
    List categories = [];

    categories = searchCategory!.contains("all") ? listCategoryFirebase : listCategoryFirebase.where((element) =>
        element.get(Constants.NAMECATEGORY).toString().toLowerCase().contains(searchCategory.trim().toLowerCase())).toList();
        ...
        children: [
          ...
          Row(
            ...
            children: [
              TextButton(
                child: Text(
                  SetLocalization.of(context)!.getTranslateValue(Keys.providerAuthCancel)!,
                  style: TextStyle(
