...
class DrawerScreenUser extends StatefulWidget {


  @override
  _DrawerScreenUserState createState() => _DrawerScreenUserState();
}

class _DrawerScreenUserState extends State<DrawerScreenUser> {
                     ...
                     children: <Widget>[
                       ...
                       Column(
                         ...
                         children: <Widget>[
                           ...
                           style: TextStyle(color: Colors.orange,fontSize: Constants.screenHeightSize(context, 15, 18) ,fontFamily: Constants.ubuntuRegularFont),)
                         ],
                       )
                     ],
                   ),
        ...
        child: InkWell(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              SizedBox(width: 5,),
              Text("Log out",style: TextStyle(color: Colors.white,fontSize: Constants.screenHeightSize(context, 21, 25),fontFamily: Constants.ubuntuRegularFont),)
            ],
          ),
